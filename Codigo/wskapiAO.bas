...
Public Sub EventoSockAccept(ByVal SockID As Long)
    ...
    If SecurityIp.IPSecuritySuperaLimiteConexiones(sa.sin_addr) Then
        ...
        str = Protocol_Write.PrepareMessageErrorMsg("Limite de conexiones para su IP alcanzado.")
    ...
    Else
        ...
        str = Protocol_Write.PrepareMessageErrorMsg("El servidor se encuentra lleno en este momento. Disculpe las molestias ocasionadas.")
