...
Private Function setRutas() As Boolean
    ...
    'Autor: Lorwik
    'Fecha: 16/05/2022
    'DescripciÛn: Establece el directorios de las rutas
    '***************************************************
    
    'Este directorio se mantendr· si o si
    ConfigPath = App.Path & "\Configuracion\"
    
    'øExiste el archivos de rutas?
...
#If DBConexionUnica = 1 Then
    ...
    If Not Load_ConfigDatBase Then
        End
    End If
    
    If Not User_Database.Database_Connect Then
        MsgBox "No se ha podido establecer conexiÛn con la base de datos de USUARIOS. Revise las credenciales o la configuraciÛn de la base de datos.", vbOKOnly Or vbCritical, "Error al establecer conexiÛn!"
        End
    End If
    
    If Not Account_Database.Database_Connect Then
        MsgBox "No se ha podido establecer conexiÛn con la base de datos de CUENTAS. Revise las credenciales o la configuraciÛn de la base de datos.", vbOKOnly Or vbCritical, "Error al establecer conexiÛn!"
        End
    End If
#End If
...
Private Sub InitMainTimers()
    ...
    '20/10/2023 - Lorwik: AÒado timer Segundo y TimerEventoPortal
    '*****************************************************************
    On Error Resume Next
...
'Autor: Lorwik
'Fecha: 02/04/2021
'DescripciÛn: Devuelve el Id de la zona donde se encuentra el usuario
'**************************************
...
'Autor: Lorwik
'Fecha: 02/04/2021
'DescripciÛn: Devuelve el Id de la zona donde se encuentra el NPC
'**************************************
On Error GoTo errHandler
...
'Autor: Lorwik
'Fecha: 02/04/2021
'DescripciÛn: Comprueba si hubo cambio de zona
'**************************************
...
Public Function ObtenerCuadranteUser(ByVal UserIndex As Integer) As Integer
    ...
    'Author: Lorwik
    'Fecha: 23/04/2021
    'DescripciÛn: Devuelve el numero del cuadrante en el que el usuario se encuentra
    '**************************************************************
    Dim cx As Integer
    Dim cy As Integer
...
Public Function ObtenerCuadrante(ByVal tX As Long, ByVal tY As Long) As Integer
    ...
    'Author: Lorwik
    'Fecha: 23/04/2021
    'DescripciÛn: Devuelve el numero del cuadrante segun las coordenadas proporcionadas
    '**************************************************************
    Dim cx As Integer
    Dim cy As Integer
...
Public Sub ObtenerCoordenadasDesdeCuadrante(ByVal numeroCuadrante As Integer, ByVal tX As Long, ByVal tY As Long, ByRef X As Integer, ByRef Y As Integer)
    ...
    'Author: Lorwik
    'Fecha: 20/10/2023
    'DescripciÛn: Calcula las coordenadas (tX, tY) a partir del n˙mero de cuadrante.
    '**************************************************************
    Dim cx As Integer
    Dim cy As Integer
    ...
    ' AquÌ, ANCHO_MAP representa el n˙mero de cuadrantes en un solo renglÛn del mapa
...
'Autor: Lorwik
'Fecha: 20/09/2024
'Descripcion: SimulaciÛn de la barra de progreso
'************************************

    ' Nos aseguramos de que el valor estÈ dentro de los lÌmites
    If Value > max Then Value = max
    
    PictureBoxBarra.Width = (Value / max) * MaxWidth ' ProporciÛn del progreso
    DoEvents
End Sub
